    ...
    <div class="wrapper">
      ...
      <div class="actions">
        ...
        <div v-else class="userActions">
          ...
          <a class="button signIn" href="#" @click.prevent="signInDialogVisible = true">登录</a>
        </div>
      </div>
    </div>
    <MyDialog title="注册" :visible="signUpDialogVisible" @close="signUpDialogVisible = false">
      <SignUpForm @success="signIn($event)" :signUpVisible="signUpDialogVisible" :signInVisible="signInDialogVisible"/>
    </MyDialog>
